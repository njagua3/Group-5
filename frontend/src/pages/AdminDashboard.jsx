// Import necessary hooks from React and axios for data fetching
import { useState, useEffect } from "react";
import axios from "axios";

// AdminDashboard component definition
export default function AdminDashboard() {
  // State hooks for managing tenants, landlords, properties, and various form inputs
  const [tenants, setTenants] = useState([]); // State for storing tenant data
  const [landlords, setLandlords] = useState([]); // State for storing landlord data
  ...
  // States for managing form data for new tenants, landlords, and properties
  ...
  const [editingTenant, setEditingTenant] = useState(null); // State for editing a tenant
  const [editingLandlord, setEditingLandlord] = useState(null); // State for editing a landlord
  const [editingProperty, setEditingProperty] = useState(null); // State for editing a property
  ...
  // Function to fetch tenants, landlords, and properties data from the API
  const fetchData = async () => {
    try {
      // Perform parallel API requests to fetch data
  ...
  const handleSearch = async () => {
    try {
      // Fetch search results based on the search query from the API
  ...
  // CREATE operations for tenants, landlords, and properties
  // Handles creating a new tenant
  const handleCreateTenant = async (e) => {
    e.preventDefault();
    try {
      // Send a POST request to the API to create a new tenant
  ...
  // Handles creating a new landlord
  ...
  // UPDATE operations for tenants, landlords, and properties
  ...
  // Handles updating an existing landlord
  ...
  // Handles updating an existing property
  ...
  // DELETE operations for tenants, landlords, and properties
    ...
    <div className="container mx-auto p-4 bg-gray-100">
      ...
      <div className="mb-6 flex flex-col md:flex-row">
        ...
        <button
          ...
          className="bg-blue-600 text-white p-3 rounded md:ml-2"
        >
          Search
        </button>
      </div>
      ...
      <div className="mb-8">
        ...
        <form
          ...
          className="mb-4 flex flex-col md:flex-row flex-grow md:w-auto flex-wrap"
        >
          <input
            type="text"
          ...
          <input
            ...
            onChange={(e) =>
              setNewTenant({
                ...newTenant,
                tenant_phone_number: e.target.value,
              })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, house_number: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, house_type: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, property_name: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, deposit_paid: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, payment_date: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({
                ...newTenant,
                receipt_number_deposit: e.target.value,
              })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, rent_amount: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({ ...newTenant, due_date: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewTenant({
                ...newTenant,
                rent_receipt_number: e.target.value,
              })
            }
            className="border p-2 m-2 flex-grow"
          />
      ...
      <div className="mb-8">
        ...
        >
          <input
            ...
            onChange={(e) =>
              setNewLandlord({ ...newLandlord, landlord_name: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewLandlord({ ...newLandlord, phone_number: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
            ...
            onChange={(e) =>
              setNewLandlord({
                ...newLandlord,
                properties_owned: e.target.value,
              })
            }
            className="border p-2 m-2 flex-grow"
          />
      ...
      <div className="mb-8">
        ...
        >
          <input
            ...
            onChange={(e) =>
              setNewProperty({ ...newProperty, property_name: e.target.value })
            }
            className="border p-2 m-2 flex-grow"
          />
          <input
          ...
          <input
            ...
            onChange={(e) =>
              setNewProperty({
                ...newProperty,
                types_of_houses: e.target.value,
              })
            }
            className="border p-2 m-2 flex-grow"
          />
